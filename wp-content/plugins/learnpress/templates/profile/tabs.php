...
<script type="text/javascript">
    ...
    // Check if the URL contains "transactions-details"
    if (window.location.href.indexOf("transactions-details") > -1) {
        // Remove active class from all tabs
        $('.lp-profile-nav-tabs li').removeClass('active');

        // Add it manually to the "orders" or "transactions" tab
        $('.lp-profile-nav-tabs li.transactions, .lp-profile-nav-tabs li.orders').addClass('active');
    }
});
