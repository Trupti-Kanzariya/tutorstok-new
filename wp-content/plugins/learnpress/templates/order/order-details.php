...
<h3><?php esc_html_e( 'Transactions Details', 'learnpress' ); ?></h3>
...
<p>
	<strong><?php echo esc_html__( 'Transaction ID:', 'learnpress' ); ?></strong>
	<?php echo esc_html( $order->get_order_key() ); ?>
</p>

<p>
	<strong><?php esc_html_e( 'Status:', 'learnpress' ); ?></strong>
...
if ( $order_date ) {
    echo '<p><strong>' . esc_html__( 'Date:', 'learnpress' ) . '</strong> ' . esc_html( date( 'F j, Y', strtotime( $order_date ) ) ) . '</p>';
} else {
    echo '<p><strong>' . esc_html__( 'Date:', 'learnpress' ) . '</strong> ' . esc_html__( 'Date not available', 'learnpress' ) . '</p>';
}
?>
