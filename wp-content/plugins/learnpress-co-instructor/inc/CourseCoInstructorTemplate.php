...
class CourseCoInstructorTemplate {
	...
	public function hooks() {
		...
		add_filter( 'learn-press/single-course/modern/section-instructor', [ $this, 'section_list_co_instructor' ], 10, 3 );
	}
	 ...
	 * @return array
	 */
	public function section_list_co_instructor( array $section, $course, $user ): array {
		$instructors = $this->addon->get_instructors( $course );
		if ( empty( $instructors ) ) {
			return $section;
		}
