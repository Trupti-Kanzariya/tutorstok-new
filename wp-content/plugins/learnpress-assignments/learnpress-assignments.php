...
define( 'LP_ADDON_ASSIGNMENT_PATH', __DIR__ );
...
class LP_Addon_Assignment_Preload {
	...
	public function load() {
		require_once LP_ADDON_ASSIGNMENT_PATH . '/vendor/autoload.php';
	...
	public function load_plugin_text_domain() {
		load_plugin_textdomain( 'learnpress-assignments', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
	}
