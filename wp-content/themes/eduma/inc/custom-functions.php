...
if ( ! function_exists( 'thim_print_breadcrumbs' ) ) {
	function thim_print_breadcrumbs() {
		...
		<div class="breadcrumbs-wrapper new-bredcum-cls-adding-before-after-remove">
			<div class="container">
				<?php
                // Check if LearnPress profile page and user is logged in
				if ( is_page( 'lp-profile' ) && is_user_logged_in() ) {
                    // Get the profile object from LearnPress
                    ...
                    // var_dump( $user = $profile ? $profile->get_user() : wp_get_current_user() );
                    // Overview tab or no tab at all
					if ( ! $current_tab || $current_tab === 'overview' ) {
                        ...
                        // Overview link
						$breadcrumbs[] = '<a href="' . esc_url( learn_press_user_profile_link( $user->ID ) ) . '">' . __( 'Overview', 'learnpress' ) . '</a>';
...
function thim_format_tab_label( $slug ) {
